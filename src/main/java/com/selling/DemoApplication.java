	...
	public void initUsers() {
		try {
			...
			if (byEmail.isEmpty()) {
				...
				userRepo.save(new User(null,"piyumal", "nipuna315np@gmail.com", "0754585756", "Admin", String.valueOf(LocalDateTime.now()), "active", null,  encodePassword, null));
			}
		} catch (Exception e) {
...
//					Thread.sleep(6000); // 120000 ms = 2 minutes
